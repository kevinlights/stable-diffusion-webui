...
class UpscalerScuNET(modules.upscaler.Upscaler):
    def __init__(self, dirname):
        ...
        self.model_url = "https://gh-proxy.com/https://github.com/cszn/KAIR/releases/download/v1.0/scunet_color_real_gan.pth"
        self.model_url2 = "https://gh-proxy.com/https://github.com/cszn/KAIR/releases/download/v1.0/scunet_color_real_psnr.pth"
